    ...
    <div class="dashboard">
        ...
        <div class="dashboard-inner select-admin-main" id="main-bar">
            ...
            <div class="dashboard-inner-main-graph">
                The Terminators (Add a Portfolio)
            </div>
                ...
                <div class="dit-heading">
                    <form action="success.php" method="POST"  enctype="multipart/form-data">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <h3>Info about the work</h3>
                                </td>
                                <td>
                                    <input type="text" name="portfolio_name" maxlength="255" required>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>
                                    <div class="button-col">
                                            <button type="submit" name="addPortfolio">submit</button>
                                        </form>
                                    </div>
                                </td>
