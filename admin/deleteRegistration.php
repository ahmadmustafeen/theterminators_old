...
$registration_info  = mysqli_query($con,"SELECT `registration_id`, `registration_name` FROM `registrations` WHERE 1"); 
    ...
    <div class="dashboard">
        ...
        <div class="dashboard-inner select-admin-main" id="main-bar">
            ...
            <div class="dashboard-inner-main-graph">
                The Terminators (Delete from Registration/License Certificate)
            </div>
                    ...
                    <form action="success.php" method="post">
                        <table>
                            <tr>
                                <td>
                                    <h3>
                                        Select existing Registration/License Certificate
                                    </h3>
                                </td>
                                <td>
                                <select name="registrationID" id="" required>
                                        <?php
                                      while($row = mysqli_fetch_assoc($registration_info)){
                                        $registration_id = $row["registration_id"];
                                        $registration_name = $row["registration_name"];
                                        ?>
                                        <option value="<?php echo $registration_id; ?>"><?php echo $registration_name ?></option>
                                        <?php
                                    }
                                    ?>
                                    </select>
                                ...
                                <td>
                                    <div class="button-col">
                                        ...
                                        <input type="text" value="" name="period_id" id="period_id"
                                            style="display:none">
                                        <button type="submit" name="deleteRegistration">Delete</button>
                    </form>
                </div>
                </td>
