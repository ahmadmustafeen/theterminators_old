    ...
    <div class="dashboard">
        ...
        <div class="dashboard-inner select-admin-main" id="main-bar">
            ...
            <div class="dashboard-inner-main-graph">
                The Terminators (Update Nature of Business)
            </div>
                ...
                <div class="dit-heading">
                    <form action="success.php" method="post" enctype="multipart/form-data">
                        <table>
                            <tr>
                                <td>
                                    <h3>Upload an Image of Section</h3>
                                </td>
                                <td>
                                    <input type="file" name="nobImage" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <h3>Select Division Number to be replaced</h3>
                                </td>
                                <td>
                                    <select name="nobNumber" id="">
                                        <option name="nobNumber" value="1">1</option>
                                        <option name="nobNumber" value="2">2</option>
                                        <option name="nobNumber" value="3">3</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <h3>Write heading about it</h3>
                                </td>
                                <td>
                                    <input type="text" name="nobHeading" maxlength="255" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <h3>Write paragraph about it (word-limit 1024)</h3>
                                </td>
                                <td>
                                    <input type="text" name="nobParagraph" maxlength="1024" required>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>
                                    <div class="button-col">
                                        ...
                                        <button type="submit" name="updateNOB">submit</button>
                    </form>
                </div>
                </td>
