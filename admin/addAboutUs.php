...
{
$contactQ  = mysqli_query($con,"SELECT `aboutText1`, `aboutText2`, `aboutText3`, `aboutHeading1`, `aboutHeading2`, `aboutHeading3` FROM `addaboutus` WHERE 1"); 
    ...
    <div class="dashboard">
        ...
        <div class="dashboard-inner select-admin-main" id="main-bar">
            ...
            <div class="dashboard-inner-main-graph">
                The Terminators (3 Highlights in About Page)
            </div>
            ...
            <div class="dashboard-inner-teacher dashboard-dit-heading">
                <div class="dit-heading">
                    <form action="./success.php" method="post">
                        ...
                        <tr>
                                <td>
                                    <h3>About us 1 Heading</h3>
                                </td>
                                <td>
                                    <input type="text" name="aboutHeading1" value="<?php echo $aboutHeading1?>">
                                </td>
                            </tr>

                            <tr>
                                <td>
                                    <h3>About us 1 Text (Wordlimit 510)</h3>
                                </td>
                                <td>
                                    <textarea style="width:400px;  resize: none;height:100px"type="text" name="aboutText1" ><?php echo $aboutText1?></textarea>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <h3>About us 2 Heading</h3>
                                </td>
                                <td>
                                    <input type="text" name="aboutHeading2" value="<?php echo $aboutHeading2?>">
                                </td>
                            </tr>

                            <tr>
                                <td>
                                    <h3>About us 2 Text (Wordlimit 510)</h3>
                                </td>
                                <td>
                                    <textarea style="width:400px;  resize: none;height:100px"type="text" name="aboutText2" ><?php echo $aboutText2?></textarea>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <h3>About us 3 Heading</h3>
                                </td>
                                <td>
                                    <input type="text" name="aboutHeading3" value="<?php echo $aboutHeading3?>">
                                </td>
                            </tr>

                            <tr>
                                <td>
                                    <h3>About us 3 Text (Wordlimit 510)</h3>
                                </td>
                                <td>
                                    <textarea style="width:400px;  resize: none;height:100px"type="text" name="aboutText3" ><?php echo $aboutText3?></textarea>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button-col">
                                            ...
                                            <button type="submit" name="addAboutUs">Update</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
