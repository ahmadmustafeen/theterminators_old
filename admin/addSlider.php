    ...
    <div class="dashboard">
        ...
        <div class="dashboard-inner select-admin-main" id="main-bar">
            ...
            <div class="dashboard-inner-main-graph">
                The Terminators (Add a New Slide in Slider)
            </div>
                ...
                <div class="dit-heading">
                    <form action="success.php" method="post" enctype="multipart/form-data">
                        <table>
                            <tr>
                                <td>
                                    <h3>Upload an Image of Slider</h3>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <h3>Select Slider Number to be replaced</h3>
                                </td>
                                <td>
                                    <select name="sliderNumber" id="">
                                        <option name="sliderNumber" value="1">1</option>
                                        <option name="sliderNumber" value="2">2</option>
                                        <option name="sliderNumber" value="3">3</option>
                                        <option name="sliderNumber" value="4">4</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <h3>Write heading about the Slider</h3>
                                </td>
                                <td>
                                    <input type="text" name="sliderHeading" maxlength="255" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <h3>Write paragraph about the Slider</h3>
                                </td>
                                <td>
                                    <input type="text" name="sliderParagraph" maxlength="255" required>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>
                                    <div class="button-col">
                                        ...
                                        <button type="submit" name="addSlider">submit</button>
                    </form>
                </div>
                </td>
