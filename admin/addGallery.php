...
{
    $categories_Q  = mysqli_query($con,"SELECT `category_id`, `category_name` FROM `categories` WHERE 1"); 
    ...
    <div class="dashboard">
        ...
        <div class="dashboard-inner select-admin-main" id="main-bar">
            ...
            <div class="dashboard-inner-main-graph">
                The Terminators (Add to Gallery)
            </div>
                ...
                <div class="dit-heading">
                    <form action="success.php" method="post" enctype="multipart/form-data">
                        <table>
                            <tr>
                                <td>
                                    <h3>Upload an Image of Gallery</h3>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <h3>Some title to remember the Gallery</h3>
                                </td>
                                <td>
                                    <input type="text" name="gallery_name" maxlength="255" required>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button-col">
                                        ...
                                        <button type="submit" name="addGallery">submit</button>
                    </form>
                </div>
                </td>
