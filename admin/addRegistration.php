    ...
    <div class="dashboard">
        ...
        <div class="dashboard-inner select-admin-main" id="main-bar">
            ...
            <div class="dashboard-inner-main-graph">
                The Terminators (Add a Registration/License Certificate)
            </div>
                ...
                <div class="dit-heading">
                    <form action="success.php" method="post" enctype="multipart/form-data">
                        <table>
                            <tr>
                                <td>
                                    <h3>Upload an Image of License/Registration</h3>
                                </td>
                                <td>
                                    <input type="file" name="registrationImage" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <h3>Info about the  License/Registration</h3>
                                </td>
                                <td>
                                    <input type="text" name="registration_name" maxlength="255" required>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>
                                    <div class="button-col">
                                            ...
                                            <button type="submit" name="addRegistration">submit</button>
                                        </form>
                                    </div>
                                </td>
