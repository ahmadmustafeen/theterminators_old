...
$tools_info  = mysqli_query($con,"SELECT `id`, `name` FROM `professional_Skills` WHERE 1");
    ...
    <div class="dashboard">
        ...
        <div class="dashboard-inner select-admin-main" id="main-bar">
            ...
            <div class="dashboard-inner-main-graph">
                The Terminators (Delete some Professional Skills)
            </div>
                    ...
                    <form action="success.php" method="post">
                        <table>
                            <tr>
                                <td>
                                    <h3>
                                        Select existing Professional Skills
                                    </h3>
                                </td>
                                <td>
                                   <select name="image_id" id="" required>
                                   <?php
                                    while($row = mysqli_fetch_assoc($tools_info)){
                                        $image_id = $row["id"];
                                        $image_name = $row["name"];
                                        ?>
                                    <option value="<?php echo $image_id?>"><?php echo $image_name?></option>
                                        <?php
                                    }
                                    ?>
                                   </select>
                                ...
                                <td>
                                    <div class="button-col">
                                            ...
                                            <input type="text" value="" name="period_id" id="period_id"
                                                style="display:none">
                                            <button type="submit" name="deleteProfessional">Delete</button>
                                        </form>
                                    </div>
                                </td>
