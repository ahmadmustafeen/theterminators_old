    ...
    <div class="dashboard">
        ...
        <div class="dashboard-inner select-admin-main" id="main-bar">
            ...
            <div class="dashboard-inner-main-graph">
                The Terminators (Delete From Gallery)
            </div>
                    ...
                    <form action="success.php" method="post">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <select name="galleryID" id="" required>
                                        <?php
                                      while($row = mysqli_fetch_assoc($gallery_info)){
                                        $gallery_id = $row["gallery_id"];
                                        $gallery_name = $row["gallery_name"];
                                        ?>
                                        <option value="<?php echo $gallery_id; ?>"><?php echo $gallery_name ?></option>
                                        <?php
                                    }
                                    ?>
                                    </select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button-col">
                                        <button type="submit" name="deleteGallery">Delete</button>
                    </form>
                </div>
                </td>
