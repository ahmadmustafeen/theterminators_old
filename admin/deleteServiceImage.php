...
$registration_info  = mysqli_query($con,"SELECT  `image_name`, `image_id` FROM `services_details` WHERE 1");
    ...
    <div class="dashboard">
        ...
        <div class="dashboard-inner select-admin-main" id="main-bar">
            ...
            <div class="dashboard-inner-main-graph">
                The Terminators (Delete some service)
            </div>
                                ...
                                <td>
                                    <div class="button-col">
                                            ...
                                            <input type="text" value="" name="period_id" id="period_id"
                                                style="display:none">
                                            <button type="submit" name="deleteServiceImage">Delete</button>
                                        </form>
                                    </div>
                                </td>
