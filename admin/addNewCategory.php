    ...
    <div class="dashboard">
        ...
        <div class="dashboard-inner select-admin-main" id="main-bar">
            ...
            <div class="dashboard-inner-main-graph">
                The Terminators (Add Category to Gallery)
            </div>
                ...
                <div class="dit-heading">
                    <form action="success.php" method="post" enctype="multipart/form-data">
                        <table>
                            <tr>
                                <td>
                                    <h3>Upload Featured Image of Gallery</h3>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <h3>Title of the Category</h3>
                                </td>
                                <td>
                                    <input type="text" name="category_name" maxlength="255" required>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>
                                    <div class="button-col">
                                            ...
                                            <button type="submit" name="addNewCategory">submit</button>
                                        </form>
                                    </div>
                                </td>
