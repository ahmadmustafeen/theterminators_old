...
$portfolio_info  = mysqli_query($con,"SELECT `portfolio_id`, `portfolio_name` FROM `portfolio` WHERE 1"); 
    ...
    <div class="dashboard">
        ...
        <div class="dashboard-inner select-admin-main" id="main-bar">
            ...
            <div class="dashboard-inner-main-graph">
                The Terminators (Delete From Portfolio)
            </div>
                    ...
                    <form action="success.php" method="post">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <select name="portfolioID" id="" required>
                                        <?php
                                      while($row = mysqli_fetch_assoc($portfolio_info)){
                                        $portfolio_id = $row["portfolio_id"];
                                        $portfolio_name = $row["portfolio_name"];
                                        ?>
                                        <option value="<?php echo $portfolio_id; ?>"><?php echo $portfolio_name ?>
                                        </option>
                                        <?php
                                    }
                                    ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button-col">
                                        <button type="submit" name="deletePortfolio">Delete</button>
                    </form>
                </div>
                </td>
