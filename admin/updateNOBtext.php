...
{
$contactQ  = mysqli_query($con,"SELECT `nob_heading`, `nob_paragraph1`, `nob_paragraph2`, `nob_paragraph3`, `nob_paragraph4` FROM `nature_of_business` WHERE 1"); 
while($row = mysqli_fetch_assoc($contactQ)){
    $nob_heading = $row['nob_heading'];
    $nob_paragraph1 = $row['nob_paragraph1'];
    $nob_paragraph2 = $row['nob_paragraph2'];
    $nob_paragraph3 = $row['nob_paragraph3'];
    $nob_paragraph4 = $row['nob_paragraph4'];
}
            ...
            <div class="dashboard-inner-teacher dashboard-dit-heading">
                <div class="dit-heading">
                    <form action="./success.php" method="post">
                        ...
                        <tr>
                                <td>
                                    <h3>Nature of Business Heading</h3>
                                </td>
                                <td>
                                    <input type="text" name="nob_heading" value="<?php echo $nob_heading?>">
                                </td>
                            </tr>

                            <tr>
                                <td>
                                    <h3>Nature of Business Paragraph (Text-limit:1024)</h3>
                                </td>
                                <td>
                                    <textarea style="width:400px;  resize: none;height:100px"type="text" name="nob_paragraph" ><?php echo $nob_paragraph1.$nob_paragraph2.$nob_paragraph3.$nob_paragraph4?></textarea>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button-col">
                                            ...
                                            <button type="submit" name="updateNOBtext">Update</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
