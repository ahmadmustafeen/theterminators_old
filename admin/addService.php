                ...
                <div class="dit-heading">
                    <form action="success.php" method="post"enctype="multipart/form-data">
                        <table>
                           <tr>
                                <td>
                                    <h3>Select Service Number to be replaced</h3>
                                </td>
                                <td>
                                    <select name="serviceNumber" id="">
                                        <option name="serviceNumber" value="1">1</option>
                                        <option name="serviceNumber" value="2">2</option>
                                        <option name="serviceNumber" value="3">3</option>
                                        <option name="serviceNumber" value="4">4</option>
                                        <option name="serviceNumber" value="5">5</option>
                                        <option name="serviceNumber" value="6">6</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <h3>Upload an Image about the work</h3>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <h3>Some Heading about the service</h3>
                                </td>
                                <td>
                                    <input type="text" name="serviceHeading" maxlength="255" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <h3>Detail paragraph about the service</h3>
                                </td>
                                <td>
                                    <input type="text" name="serviceText" maxlength="255" required>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>
                                    <div class="button-col">
                                            ...
                                            <button type="submit" name="addService">submit</button>
                                        </form>
                                    </div>
                                </td>
