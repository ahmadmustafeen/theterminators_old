...
$servicesParagraph = "Services Paragraph";
$contactParagraph = "Contact Paragraph";
    ...
    <div class="dashboard">
        ...
        <div class="dashboard-inner select-admin-main" id="main-bar">
            ...
            <div class="dashboard-inner-main-graph">
                The Terminators (Edit Header Logo)
            </div>
                                    ...
                                    <div class="button-col">
                                        <form action="./showAttendanceClass.php" method="POST">
                                            <input type="text" value="" name="period_id" id="period_id"
                                                style="display:none">
                                            <button type="submit" name="header">Update</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
