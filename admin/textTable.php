...
{
$contact_info  = mysqli_query($con,"SELECT * FROM `table_para` WHERE 1"); 
while($row = mysqli_fetch_assoc($contact_info)){
    $aboutusHeading = $row["text_heading"];
    $aboutusParagraph1 = $row["text_para1"];
    $aboutusParagraph2 = $row["text_para2"];
    $aboutusParagraph3 = $row["text_para3"];
    $aboutusParagraph4 = $row["text_para4"];
}
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button-col">
                                        <button type="submit" name="textTable">Update</button>
                    </form>
                </div>
                </td>
                </tr>
