    ...
    <div class="dashboard">
        ...
        <div class="dashboard-inner select-admin-main" id="main-bar">
            ...
            <div class="dashboard-inner-main-graph">
                The Terminators (Add new service)
            </div>
                ...
                <div class="dit-heading">
                    <form action="./success.php" method="post">
                        ...
                        <tr>
                                ...
                                <td>
                                    <input type="text" name="serviceHeading" >
                                </td>
                            </tr>

                            <tr>
                                <td>
                                    <h3>Service Paragraph</h3>
                                </td>
                                <td>
                                    <textarea style="width:400px;  resize: none;height:100px"type="text" name="serviceParagraph" ></textarea>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button-col">
                                            ...
                                            <button type="submit" name="AddServiceText">Update</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
