...
$gallery_info  = mysqli_query($con,"SELECT `portfolio_id`, `portfolio_name` FROM `portfolio` WHERE 1"); 
?>
...
while($row = mysqli_fetch_assoc($gallery_info)){
    $portfolio_id = $row["portfolio_id"];$i++;$j++;
 ...
 <div class="card" id="cards">
                <img class="card-img-top" src="./Portfolio/portfolio<?php echo $portfolio_id;?>.png" id="img<?php echo $registration_id?>" onclick="onPRess(this.id)">
                <div class="card-body">
